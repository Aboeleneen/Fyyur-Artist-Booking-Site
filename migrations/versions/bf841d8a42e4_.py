...
Revision ID: bf841d8a42e4
Revises: 4670fc3b288d
Create Date: 2020-02-09 17:09:14.018187
...
revision = 'bf841d8a42e4'
down_revision = '4670fc3b288d'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.ForeignKeyConstraint(['show_id'], ['Artist.id'], name='Show_show_id_fkey'),
